export const BlockchainServices = [
  {
    ...
    card_title: "Blockchain Consulting",
    card_para:
      "Brainstorm and ideate blockchain solutions for fintech, healthcare, telecom, real estate, and media.",
  },
  {
    card_href: "/blockchain-dev",
    card_title: "Co Development Model",
    card_para:
      "Collaborative solutions across multiple technologies fusing R&D and value-chain participation strategies.",
  },
  {
    card_href: "/blockchain-dev",
    card_title: "Smart contract development",
    card_para:
      "Build secure and reliable  crypto wallets compatible with multiple cryptocurrencies.",
  },
  {
    card_href: "/blockchain-dev",
    card_title: "Blockchain  Decentralization",
    card_para:
      "Ensure strict security with a decentralized setup laid out by experts for every",
  },
  {
    card_href: "/blockchain-dev",
    card_title: `E-Wallet Platforms`,
    card_para:
      "Robust and secure platforms  and e-wallets built under one roof to serve various",
  },
  {
    card_href: "/blockchain-dev",
    card_title: "Blockchain cloud  services",
    card_para:
...
export const BlockchainDevProcess = [
  ...
  {
    card_href: "/blockchain-dev",
    card_title: "Experience and Design",
    card_para:
  ...
  {
    card_href: "/blockchain-dev",
    card_title: "Blockchain Deployement",
    card_para:
  ...
  {
    card_href: "/blockchain-dev",
    card_title: `Blockchain Maintenance`,
    card_para:
